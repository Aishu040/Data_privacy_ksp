...
def options():
    if request.method == 'POST':
        return redirect(url_for('index'))  # Redirect to index.html after options form submission
    return render_template('options.html')

@app.route('/index', methods=['GET', 'POST'])
def index():
    if request.method == 'POST':
        return redirect(url_for('masking'))  # Redirect to masking.html after index form submission
